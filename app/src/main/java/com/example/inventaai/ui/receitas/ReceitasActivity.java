...
public class ReceitasActivity extends AppCompatActivity {
    ...
    private TextInputEditText         etBusca;          // Sprint 14
    ...
    protected void onResume() {
        ...
        // Reseta busca ao voltar para a tela
        if (etBusca != null && etBusca.getText() != null
                && etBusca.getText().toString().isEmpty()) {
            carregarReceitas("");
        } else {
    ...
    private void vincularViews() {
        ...
        etBusca             = findViewById(R.id.etBuscaReceitas); // Sprint 14
    ...
    /** Sprint 14: observa mudanças no campo de busca e recarrega a lista. */
    ...
    private void carregarReceitas(String query) {
        ...
        AppExecutors.diskIO().execute(() -> {
            ...
            if (query == null || query.trim().isEmpty()) {
                lista = receitaRepository.listarTodas(currentUserId);
            } else {
                lista = receitaRepository.buscarPorTituloOuIngrediente(query, currentUserId);
            }
