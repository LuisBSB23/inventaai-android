...
public class ReceitasConcluidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receitas_concluidas);
    ...
    private void confirmarDelecao(ReceitaSalva receita, int position) {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Deseja remover \"" + receita.getTitulo() + "\" do histórico?")
